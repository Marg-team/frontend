...
export default function ReportTile({type=0, header, him_homeless, phone, address, about}) {
    return (
        <div className={styles.tile}>
            <div className={styles.content}>
                ...
                <div className={styles.items}>
                    <span>Type:</span>
                    <span>{him_homeless?"Myself":"Others"}</span>
                </div>
                <div className={styles.items}>
                    <span>Phone No.:</span>
            ...
            <div className={styles.buttons}>
                <button className={styles.primary_btn}>{type===0?'ASSIGN':'DONE'}</button>
